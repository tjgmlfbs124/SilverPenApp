...
Blockly.Constants.Logic.CONTROLS_IF_MUTATOR_MIXIN = {
	...
	compose: function (a) {
		...
		for (b = 1; b <= this.elseifCount_; b++)
			Blockly.Mutator.reconnect(a[b], this, "IF" + b), Blockly.Mutator.reconnect(c[b], this, "DO" + b);
...
Blockly.Blocks.procedures_defnoreturn = {
	...
	compose: function (a) {
		...
		for (var b = a.getInputTargetBlock("STACK"); b; )
			this.arguments_.push(b.getFieldValue("NAME")), this.paramIds_.push(b.id), b = b.nextConnection && b.nextConnection.targetBlock();
		this.updateParams_();
		Blockly.Procedures.mutateCallers(this);
		...
		if (null !== a && (a = "TRUE" == a,
			...
			if (a)
				this.setStatements_(!0), Blockly.Mutator.reconnect(this.statementConnection_, this, "STACK"), this.statementConnection_ = null;
			else {
	...
	updateShape_: function () {
		for (var a = 0; a < this.arguments_.length; a++) {
			...
			if (b) {
				...
				b = new Blockly.FieldLabel(this.arguments_[a]), this.appendValueInput("ARG" + a).setAlign(Blockly.ALIGN_RIGHT).appendField(b,
					"ARGNAME" + a).init()
		}
	...
	onchange: function (a) {
		if (this.workspace &&
			...
			if (a.type == Blockly.Events.BLOCK_CREATE && -1 != a.ids.indexOf(this.id)) {
				...
				a.type == Blockly.Events.BLOCK_DELETE && (b = this.getProcedureCall(), b = Blockly.Procedures.getDefinition(b, this.workspace), b || (Blockly.Events.setGroup(a.group), this.dispose(!0, !1), Blockly.Events.setGroup(!1)))
	},
	customContextMenu: function (a) {
		var b = {
			enabled: !0
...
//Blockly.Extensions.registerMutator("procedures_defnoreturn_mutator", Blockly.Constants.Text.TEXT_CHARAT_MUTATOR_MIXIN, null);
