...
public abstract class BlocklyEvent {
    ...
    public static final int TYPE_CREATE = 1 << 0;   // 1
    public static final int TYPE_DELETE = 1 << 1;   // 2
    public static final int TYPE_CHANGE = 1 << 2;   // 4
    public static final int TYPE_MOVE = 1 << 3;     // 8
    public static final int TYPE_UI = 1 << 4;       // 16
    ...
    protected BlocklyEvent(@EventType int typeId, JSONObject json) throws JSONException {
        ...
        Log.i("HTS_EVENT", "BlocklyEvent contructs...");
        Log.i("HTS_EVENT", "mTypeId => " + mTypeId);
        Log.i("HTS_EVENT", "mWorkspaceId => " + mWorkspaceId);
        Log.i("HTS_EVENT", "mGroupId => " + mGroupId);
        Log.i("HTS_EVENT", "mBlockId => " + mBlockId);
        Log.i("HTS_EVENT", "json => " + json);
    }
    ...
    public static final class ChangeEvent extends BlocklyEvent {
        ...
        public ChangeEvent(@ChangeElement String element, @NonNull Block block,
            ...
            // dialog에서 값을 변경할 때. ( colorWipe_number만, base_delay, loop 는 발생안함.. 왜? )
            Log.i("HTS_EVENT", "ChangeEvent");
    ...
    public static final class MoveEvent extends BlocklyEvent {
        ...
        public void recordNew(Block block) {
            Log.i("HTS_EVENT", "[MoveEvent]recordNew");
    ...
    public static final class UIEvent extends BlocklyEvent {
        ...
        public UIEvent newBlockCommentEvent(@NonNull Block block,
            ...
            Log.i("HTS_EVENT", "[UIEvent]newBlockCommentEvent");
        ...
        public UIEvent newBlockMutatorEvent(@NonNull Block block,
                                            boolean openedBefore, boolean openedAfter) {
            Log.i("HTS_EVENT", "[UIEvent]newBlockMutatorEvent");
        ...
        public UIEvent newBlockSelectedEvent(@NonNull Block block,
            ...
            Log.i("HTS_EVENT", "[UIEvent]newBlockSelectedEvent");
        ...
        public UIEvent newBlockWarningEvent(@NonNull Block block,
                                            boolean openedBefore, boolean openedAfter) {
            Log.i("HTS_EVENT", "[UIEvent]newBlockWarningEvent");
        ...
        public UIEvent newToolboxCategoryEvent(@Nullable String oldValue,
                                               @Nullable String newValue) {
            Log.i("HTS_EVENT", "[UIEvent]newToolboxCategoryEvent");
