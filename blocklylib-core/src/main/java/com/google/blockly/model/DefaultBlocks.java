...
public final class DefaultBlocks {
     ...
     * Custom blocks..
     */
    public static final String CONTROL_BLOCKS_PATH = "default/control_blocks.json";
    ...
    public static final String MOTION_BLOCKS_PATH = "default/motion_blocks.json";
    public static final String MISSION_BLOCKS_PATH = "default/mission_blocks.json";

    /** Path to a toolbox that has most of the default blocks organized into categories. */
//    public static final String TOOLBOX_PATH = "default/toolbox1.xml";
