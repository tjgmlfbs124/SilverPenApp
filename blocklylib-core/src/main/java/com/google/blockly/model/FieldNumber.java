...
public final class FieldNumber extends Field {
    ...
    private static final DecimalFormatSymbols PERIOD_AS_DECIMAL = new DecimalFormatSymbols(new Locale("en", "us"));
    /**
    ...
    static {
        ...
        NAIVE_DECIMAL_FORMAT = new DecimalFormat(new StringBuffer("0.").append(sigDigts).toString(), PERIOD_AS_DECIMAL);
    }
