...
public class Block extends Observable<Block.Observer> {
    ...
    public CodeEventInterface mChangeEvent;

    /**
     * 이벤트를 전달 받을 리스너를 등록한다.
     * @param listener
     */
    public void setChangeEvent(CodeEventInterface listener)
    {
        mChangeEvent = listener;
    }
    ...
    // @HTS
    @Nullable
    public void set_Out_Previous_Next_putConnection(Connection Out, Connection Previous, Connection Next)
    {
        mOutputConnection = Out;
        mPreviousConnection = Previous;
        mNextConnection = Next;
    }
