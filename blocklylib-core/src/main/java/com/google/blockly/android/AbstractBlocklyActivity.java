...
//    protected BlocklyActivityHelper mBlocklyActivityHelper;
    public BlocklyActivityHelper mBlocklyActivityHelper;
    ...
    public void onBackPressed() {
        ...
        // 작업을 취소하기 전에 열려있는 서랍 / 도구 상자를 닫으십시오.
...
//    @NonNull
//    abstract protected BluetoothGattCallback getBluetoothGattCallback();
...
//        mActionBar.setDisplayShowTitleEnabled(true);
    ...
    /*
    // 여기서 정렬하지 않는다. Code로 변환될때 정렬한다.
    // ====> Workspace.Java의 serializeToXml함수에서 getRootBlocks의 결과물을 X/Y 순서의 우선순위로 정렬하여 코드로 변환해준다.
    protected void getWorkspace_Blocks_ByXY()
    {
        ArrayList<Block> root_blocks = getController().getWorkspace().getRootBlocks();

//        for(int i = 0; i < root_blocks.size(); i++)
//        {
//            Log.i("JS", "root_blocks.get(i) => " + root_blocks.get(i));
//            Log.i("JS", "root_blocks.get(i).getPosition() => " + root_blocks.get(i).getPosition());
//        }

        Collections.sort(root_blocks, sortByXY);

//        Log.i("JS", "[1]WORKSPACE_BLOCKS => " + WORKSPACE_BLOCKS);
//        for(int i = 0; i < root_blocks.size(); i++)
//        {
//            Log.i("JS", "root_blocks[" + i + "]Block => " + root_blocks.get(i));
//        }
