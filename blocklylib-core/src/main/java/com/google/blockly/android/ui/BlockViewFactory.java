...
public abstract class BlockViewFactory<BlockView extends com.google.blockly.android.ui.BlockView,
    ...
    public final BlockView buildBlockViewTree(Block block, BlockGroup parentGroup,
        ...
        List<InputView> inputViews = buildInputViews(block, connectionManager, touchHandler, isEXE);
...
//            Log.i("JS", "blockview next => " + next );
    ...
    // TODO(#589): Testing
    @NonNull
    public BlockView rebuildBlockView(BlockView original, boolean isEXE) {
        ...
        List<InputView> inputViews = buildInputViews(model, connectionManager, touchHandler, isEXE);
     ...
     */
    protected FieldView buildFieldView(Field field, boolean isEXE) {
...
//        Log.i("seo","type : " + type);
        switch (type) {
            ...
            case Field.TYPE_VARIABLE: {
                ...
                fieldVariableView.setField(field, isEXE);
            ...
            case Field.TYPE_NUMBER: {
                ...
                fieldNumberView.setField(field, isEXE);
    ...
    protected List<InputView> buildInputViews(
            Block block, ConnectionManager connectionManager, BlockTouchHandler touchHandler, boolean isEXE) {
        ...
        for (int i = 0; i < inputCount; i++) {
            ...
            for (int  j = 0; j < fields.size(); j++) {
                fieldViews.add(buildFieldView(fields.get(j), isEXE));
            }
