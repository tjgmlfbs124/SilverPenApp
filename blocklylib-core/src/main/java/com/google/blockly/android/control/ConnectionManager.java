...
public class ConnectionManager {
    ...
    public YSortedList getmNextConnections()
    {
        return mNextConnections;
    }

    public YSortedList getmInputConnections()
    {
    ...
    @VisibleForTesting
    public YSortedList getConnections(int connectionType) {
    ...
    public class YSortedList {
        ...
        public List<Connection> getmConnections()
        {
            return mConnections;
        }
