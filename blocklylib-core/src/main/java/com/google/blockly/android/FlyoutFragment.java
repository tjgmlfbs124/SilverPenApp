...
public class FlyoutFragment extends Fragment implements BlockListUI {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        /***
         * @auth HTS
         * flyout을 드래그할때 좀 더 편히 하기 위해서 오른쪽에 여백을 지정함.
         */
//        mFlyoutView.setPadding(0, 0, 50, 0);
//        mFlyoutView.set
//        RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT,RelativeLayout.LayoutParams.MATCH_PARENT);

//        Log.i("seo","get width : " + mFlyoutView.getWidth());
//        mFlyoutView.setLayoutParams(params);
...
//        Log.i("HTS", "category => " + category.getCategoryName());
...
//            ViewGroup.LayoutParams params = mFlyoutView.getLayoutParams();
//            params.width = 1000;
//            mFlyoutView.setLayoutParams(params);

            Log.i("seo", "mFlyoutView open! [width = > " + mFlyoutView.getWidth() + "]");
