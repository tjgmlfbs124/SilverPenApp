...
public class IfElseMutatorFragment extends MutatorFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        SwitchButton switchButton = (SwitchButton) contentView.findViewById(R.id.switch_button);
        switchButton.setChecked(mHasElse);
        /** @HTS
         * SwitchButton의 다양한 Option들
         */
