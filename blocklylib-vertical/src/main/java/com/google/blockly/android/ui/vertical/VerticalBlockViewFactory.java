...
public class VerticalBlockViewFactory extends BlockViewFactory<BlockView, InputView> {
    ...
    protected FieldView buildFieldView(Field field, boolean isEXE) {
        ...
        if (layoutResId != 0) {
//            try{
//                Log.i("seo","layoutResId : " + layoutResId);
//                Log.i("seo","isEXE : " + isEXE);
//                Log.i("seo","field.getName().toString() : " + field.getName());

                fieldView = (FieldView) mLayoutInflater.inflate(layoutResId, null);
                fieldView.setField(field, isEXE);
//            }catch (Exception e){
//                Log.i("seo","error : " + e);
//            }
        ...
        switch (type) {
            ...
            default:
                if (fieldView == null) {
                    fieldView = super.buildFieldView(field, isEXE);
                }
                break;
        }
        return fieldView;
...
//            adapter.setDropDownViewResource(R.layout.default_spinner_dropdown_item);
            ...
            // item style custom... @HTS ( variables 전용! )
