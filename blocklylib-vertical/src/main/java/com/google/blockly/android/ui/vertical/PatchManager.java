...
public class PatchManager {
    ...
    private void computePatchLayoutMeasures(boolean rtl, boolean useHat) {
        Log.i("HTS", "computePatchLayoutMeasures");
        ...
        mValueInputWidth = getPatchDrawable(R.drawable.value_input_external).getIntrinsicWidth() - mBlockEndPadding;

        final NinePatchDrawable bottomPatchDefault = getPatchDrawable(R.drawable.bottom_start_default);
...
//        mBlockBottomPadding = mTempRect.bottom - 20;
...
//        mNextConnectorHeight = mTempRect.bottom - mBlockBottomPadding - 20;
        ...
        final NinePatchDrawable topLeftPreviousPatch = getPatchDrawable(R.drawable.top_start_previous);
        ...
        mBlockTopDefaultMinPadding = Math.min(mBlockTopDefaultPadding, Math.min(mBlockTopOutputPadding, mBlockTopPreviousPadding));
        mBlockTopHatMinPadding = Math.min(mBlockTopHatPadding, Math.min(mBlockTopOutputPadding, mBlockTopPreviousPadding));
        ...
        // statement는 repeat ~ do 에서 do자리. 상관없음.
        ...
        final NinePatchDrawable statementBottomPatch = getPatchDrawable(R.drawable.statementinput_bottom);
        ...
        mStatementMinHeight = statementTopPatch.getIntrinsicHeight() + statementBottomPatch.getIntrinsicHeight();
        ...
        mInlineInputMinimumHeight = inlineInputPatch.getIntrinsicHeight() - 50;

//        mTempRect.bottom = mTempRect.bottom - 20;
        inlineInputPatch.getPadding(mTempRect);
        mInlineInputStartPadding = rtl ? mTempRect.right : mTempRect.left;
        mInlineInputTopPadding = mTempRect.top;                            // input top.
//        mInlineInputTopPadding = mTempRect.top - 20;                            // input top.
        mInlineInputTotalPaddingX = mTempRect.left + mTempRect.right;
        mInlineInputTotalPaddingY = mTempRect.top + mTempRect.bottom;      // input bottom.
//        mInlineInputTotalPaddingY = mTempRect.top + mTempRect.bottom - 30;      // input bottom.
